         ...
         <div class="detail_t_left">
           <div class="detail_l_top">
             <div class="detail_l_out">
               <div class="header-2">
                 <a href="${ctxPath}/search-prod.html?brandId=${brand.id}" target="_blank"><h3>${product.brand.designer}</h3></a>
               </div><!--header-2-->
  			...
  			<div id="skuOptions">
                 <c:forEach items="${productSkuOptionAndValues}" var="productSkuOptionAndValue">
                 	<div class="tb-prop tm-clear">
							<c:if test="${productSkuOptionAndValue.key.skuOptionCode=='color'}">
							...
							<c:if test="${productSkuOptionAndValue.key.skuOptionCode=='size'}">
            ...
            <div class="sidebar">
                <ul>
	                ...
	                <span id="siderbar_title">该设计师其他款式</span>
	                   ...
	                   <ul class="sub-menu">
	                   	<li>
	                       <a href="" id="p_designer_oth" class="current"><span class="sub_active"></span>该设计师其他款式</a>
	                     </li>
	                     <li>
