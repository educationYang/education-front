                   ...
                   <div id="section-1" class="sale_s">
					...
					<div class="mediabox">
                      <div class="shoe_show">
                       ...
                       <a href="<product:productUrl product="${ sekillProductListDay1Item.product}" />?flag=${sekillProductListDay1Item.status }" title="${sekillProductListDay1Item.product.title}">
			...
			<div id="section-2" class="sale_s">
					...
					<div class="mediabox">
                      ...
                      <product:productImg product="${sekillProductListDay2Item.product}"flag="${sekillProductListDay2Item.status }" size="v" isLazyload="false"/>
                        ...
                        <a href="<product:productUrl product="${ sekillProductListDay2Item.product}" />?flag=${sekillProductListDay2Item.status }" title="${sekillProductListDay2Item.product.title}">
                        <div class="btn start"> 查看详情</div>
                        <%--秒杀立即够买 
			...
			<div id="section-3" class="sale_s">
				...
				<c:forEach items="${sekillProductListDay3}" var="sekillProductListDay3Item" varStatus="varStatus">
					<div class="mediabox">
                      ...
                      <a href="<product:productUrl product="${ sekillProductListDay3Item.product}" />?flag=${sekillProductListDay3Item.status }" title="${sekillProductListDay3Item.product.title}">
                    <div class="btn start"> 查看详情</div>
                      <%--秒杀立即够买
