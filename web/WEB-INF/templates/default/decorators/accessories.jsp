...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	<head>
	   <title>优农乐选网-设计师品牌首饰、配饰、手工配饰【设计师品牌正品保障】</title>	
		<meta name="keywords" content="设计师品牌配饰、首饰，手工配饰，手绳，项链，手链，优农乐选网" />
		<meta name="description" content="优农乐选网.com配饰频道，提供设计师品牌首饰，配饰，手工配饰款式，图片，价格，评价等信息，其中很多首饰和配饰在国内仅在优农乐选网有售。" />
                  ...
                  <ul class="sort_list">
                     <product:showCategorys categoryType="1" displayCategoryId="1" displayLevel="1" excludeCode="all"></product:showCategorys>
                        	<c:forEach items="${categoryTreeItems}" var="categoryTreeItem">
					        	<li>
					        		<c:if test="${categoryTreeItem.name != '关于优农乐选'}">
