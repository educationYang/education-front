...
function openFancybox() {
    setTimeout( function() {$('#various1').trigger('click'); },6000);
}
...
<!-- panes -->
  ...
  <a href="http://www.sifangstreet.com/new-arrivals/shoespresell_catalog.html"><span class="date-info">More+</span></a>
  </div><!--items-->
  <div class="items">
...
<a href="http://www.sifangstreet.com/new-arrivals/accepresell_catalog.html"><span class="date-info">More+</span></a>
