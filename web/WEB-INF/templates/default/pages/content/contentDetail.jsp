	...
	<c:if test="${content.id == 18 || content.id == 19 || content.id == 27}">
		...
		<div class="maincontent">
	         ...
	         <div class="position-wrap portfolio_item_text">
	            ...
	            <span class="selected">关于优农乐选</span>
	         </div>
	         
	         <div class="about_nav">
	            <ul id="remote_nav_ul">
	              <li><a id="t1" href="#tab1" title="关于优农乐选" <c:if test="${content.id==18 }">class="current"</c:if>>关于优农乐选&middot;</a></li>
	         ...
	         <div class="about_all" id="tab1">
	           ...
	           <div class="top_about">
	             <div class="about_us">
	                <p><span class="smalltop">优农乐选目前由天津农商银行运营</span>
	                <h1 class="about_slogan">我们是优农乐选</h1>
	         ...
	         <div class="about_all" id="tab2">
	           ...
	           <div class="contact_us" >
	            <h1 class="about_slogan">联系优农乐选</h1>
	            ...
	            <ul class="list_icon_items">
	              ...
	              <li>
	                ...
	                <div class="icon_width">
	                    ...
	                    <p>
	                        <span class="pseudo-link">关注优农乐选</span>
	                    </p>
	                </a>
	              ...
	              <li>
	                ...
	                <div class="icon_width">
	                    ...
	                    <p>
	                        <span class="pseudo-link">搜索优农乐选或点击打开二维码</span>
	                    </p>
	                </a>
	              </li>
	              <li>
	            ...
	            <h2 class="align_center">欢迎莅临优农乐选体验店</h2>
				...
				<div class="map-lower">
					<div class="grid-9">
	                    ...
	                    <div class="dec">
	                      ...
	                      <p><i class="fa fa-university fa-lg padding_right10"></i>天津农商银行</p>
	                    </div>
					</div>
				</div>
			</div>
	         ...
	         <div class="about_all" id="tab3">
	           ...
	           <div class="join_us">
	            <h1 class="about_slogan">加入优农乐选</h1>
	            <h3 class="join_us_title_down">
	              优农乐选SiFangStreet.com由天津农商银行（下称“本公司”或“我们）拥有和运营。
	              <br/>
	              “成就设计梦想”是名度网络的使命，为爱美族提供触手可及的设计师轻时尚产品。
	              <br/>我们需要服务热忱的伙伴提供专业及优质的服务，将优农乐选SiFangStreet的品牌精神传达给消费者。
	              <br/>
	              如果你也喜爱和认同优农乐选SiFangStreet，请加入我们！
	            </h3>
	            <hr>
