           ...
           <div class="detail_l_top">
             <div class="detail_l_out">
               ...
               <div class="designer_story">
                  <p style="cursor: pointer;">${param.flag}品牌故事<span><i class="fa fa-caret-right fa-lg"></i></span></p>
               </div><!--designer_story-->
             </div><!--detail_l_out-->
           </div><!--detail_l_top-->
              ...
              <div class="social_part">
                ...
                <script>
				  window._bd_share_config = {
					  common : {
						  bdText : '我在优农乐选看中了一款产品，觉得不错，希望小伙伴们能给我出出主意，到底要哪个颜色好呢？中国首家新锐设计师多品牌集成店——优农乐选网站   ',	
						  bdMini : '2',	
