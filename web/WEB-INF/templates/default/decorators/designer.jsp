...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	<head>
		<title>全球新锐设计师-设计师品牌集成|优农乐选网</title>	
		<meta name="keywords" content="优农乐选，优农乐选网，设计师品牌集成店，原创品牌，都市时尚，女鞋，饰品，个性，定制，sifangstreet" />
		<meta name="description" content="优农乐选网全球新锐设计师频道，提供优农乐选进驻的新锐设计师及设计师品牌商品信息，新锐设计师个人经历、品牌故事，设计师原创设计、个性时尚、与众不同的商品图片、价格、促销、导购信息。" />
				...
				<c:if test="${fn:substring(brand.brandCode,0,11)=='accessories'}">		     	
	        		<li class="accessories">
		              <a class="fancybox" href="#${brand.sortOrder}" title="${brand.designer}（${brand.countryCode}）">
		                ...
		                hhh <cartmatic:img url="${brand.icon}" mediaType="other"></cartmatic:img>
		                  <div class="infor">
				 ...
				 <div id="${brand.sortOrder}" class="desginer_detail">
		            <div class="fancy_left">
		              ...
		              <div class="fancy_l_down">
		                 <p><span>eee设计师：</span>${brand.designer}（${brand.countryCode}）</p>
		                 <p><span>ff品牌：</span>${brand.brandName}</p>
